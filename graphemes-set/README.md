...
- `npm run start:full` to run the script with all columns generated, generating `output-full.csv`
- `npm run start:compact` for minimal columns, generating `output-compact.csv`
